...
> It is <span style="color: purple;">causal</span>, not just because of the word "*cause*" but also for the <span style="color: purple;">context of the question</span>. A gene truncation involves <span style="color: purple;">an experimental study</span> to check whether there is an outcome from this study: <span style="color: purple;">cancer appearance</span>.
